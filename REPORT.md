...
Ничего нового не узнал. Столкнулся с трудностями публикации контейнеров в GHCR из-за заваливавшихся тестов в Workflow, но они были изменены, как и docker-compose для тестов - были явно указаны ссылки на образы и изменены порты приложения
